    ...
    <div>
        ...
        <Modal v-model="modalSetting.show" width="700" :styles="{top: '30px'}" @on-visible-change="doCancel">
            ...
            <Form ref="myForm" :rules="ruleValidate" :model="formItem" :label-width="100">
                ...
                <FormItem label="比赛办法" prop="match_way">
                    <Input type="textarea" :rows="4" v-model="formItem.match_way" placeholder="比赛办法"/>
                </FormItem>
            </Form>
            <div slot="footer">
...
<script>
    import {getDataList, coruData} from '@/api/cbo_match_way_index'
        ...
        return h('Button', {
            ...
            on: {
                'click': () => {
                    ...
                    vm.formItem.match_way = currentRow.match_way;
    ...
    export default {
        ...
        data() {
            return {
                ...
                searchConf: {},
                // 表单属性
                formItem: {id: "", match_type: "", match_way: ""},
                // modal属性
                modalSetting: {
                    show: false,
                    loading: false,
