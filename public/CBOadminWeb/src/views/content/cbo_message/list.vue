...
<script>
    ...
    export default {
        ...
        data() {
            return {
                // 初始化表格列
                columnsList:[{title:"消息id",key:"id",align:"center"},{title:"消息标题",key:"title",align:"center"},{title:"消息内容",key:"content",align:"center"},{title:"消息日期",key:"date",align:"center"},{title:"操作",key:"handle",align:"center",handle:["edit","delete"]}],
                // 表格数据
                tableData: [],
                // 表格显示分页属性
                tableShow: {
                ...
                // 搜索配置
                                ...
                                // 表单属性
                                formItem:{id:"",title:"",content:"",date:""},
                                // modal属性
                modalSetting: {
                    show: false,
                    loading: false,
